...
namespace {
    ...
    class Paginator extends \Illuminate\Support\Facades\Paginator{
         ...
         * @static 
         */
        public static function setupPaginationEnvironment($view){
            \Illuminate\Pagination\Factory::setupPaginationEnvironment($view);
        }
         ...
         * @static 
         */
        public static function setTranslator($trans){
            return \Illuminate\Pagination\Factory::setTranslator($trans);
        }
